...
public interface SessionApi {
     ...
     * <br>
     * Note: for backwards compatibility with previous drafts of this specification, the parameters may also be specified as
     * application/x-form-www-urlencoded data. However, this usage is deprecated.
     *
     * @param request         JSON body request.
     * @param servletRequest  Servlet request.
     * @param servletResponse Servlet response.
    ...
    @ApiOperation(
        ...
        notes = "The identity server will send an SMS message containing a token. If that token is presented to the identity server"
            ...
            + " previous drafts of this specification, the parameters may also be specified as application/x-form-www-urlencoded data."
            + " However, this usage is deprecated."
    )
    @ApiResponses( {
        @ApiResponse(code = 200, message = "Session created."),
