 ...
 */
@ApiModel(description = "The sid generated for this session to the caller, in a JSON object containing the sid key.")
public class SessionResponse {
     ...
     */
    @ApiModelProperty(
        value = "The session ID. Session IDs are opaque strings generated by the identity server. They must consist entirely of"
