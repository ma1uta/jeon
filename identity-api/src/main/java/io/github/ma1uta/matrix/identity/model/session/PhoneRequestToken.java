 ...
 */
@ApiModel(description = "JSON body request of the creating an phone association.")
public class PhoneRequestToken {
    ...
    @ApiModelProperty(
        name = "send_attempt",
        value = "The server will only send an email if the send_attempt is a number greater than the most recent one which"
