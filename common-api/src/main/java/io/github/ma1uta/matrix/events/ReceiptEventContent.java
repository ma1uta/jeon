...
import io.github.ma1uta.matrix.events.nested.ReceiptTs;
 ...
 */
public class ReceiptEventContent extends HashMap<String, Map<String, Map<String, ReceiptTs>>> implements EventContent {

    @Override
    public String type() {
        return Event.EventType.RECEIPT;
    }
}
