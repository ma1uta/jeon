...
import geek.ma1uta.matrix.client.model.device.Device;
import geek.ma1uta.matrix.client.model.device.DeviceDeleteRequest;
import geek.ma1uta.matrix.client.model.device.DeviceUpdateRequest;
import geek.ma1uta.matrix.client.model.device.DevicesResponse;
