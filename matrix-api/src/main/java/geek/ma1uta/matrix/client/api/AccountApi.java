...
import geek.ma1uta.matrix.client.model.account.RegisterRequest;
import geek.ma1uta.matrix.client.model.account.RequestToken;
import geek.ma1uta.matrix.client.model.auth.LoginResponse;
import geek.ma1uta.matrix.client.model.account.DeactivateRequest;
import geek.ma1uta.matrix.client.model.account.PasswordRequest;
import geek.ma1uta.matrix.client.model.account.ThreePidRequest;
import geek.ma1uta.matrix.client.model.account.ThreePidResponse;
import geek.ma1uta.matrix.client.model.account.WhoamiResponse;
