...
public interface ApplicationApi {
     ...
     *
     * @param txnId   Required. The transaction ID for this set of events. Homeservers generate these IDs and they are used to ensure
    ...
    EmptyResponse transaction(@PathParam("txnId") String txnId, TransactionRequest request);
    ...
    EmptyResponse rooms(@PathParam("roomAlias") String roomAlias);
    ...
    @GET
    @Path("/users/{userId}")
    EmptyResponse users(@PathParam("userId") String userId);
}
