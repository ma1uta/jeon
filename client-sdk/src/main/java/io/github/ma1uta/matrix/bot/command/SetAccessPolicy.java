 ...
 * @param <E> extra data.
 */
public class SetAccessPolicy<C extends BotConfig, D extends BotDao<C>, S extends Service<D>, E> implements Command<C, D, S, E> {
    @Override
    public String name() {
        return "policy";
    }
    ...
    public void invoke(BotHolder<C, D, S, E> holder, Event event, String arguments) {
        ...
        holder.getMatrixClient().sendFormattedNotice(config.getRoomId(), "usage: !policy [all|owner]");
    }
