 ...
 * DAO for matrix bot.
 */
public class BotDao extends AbstractDAO<BotConfig> {
     ...
     */
    public BotDao(SessionFactory sessionFactory) {
     ...
     * @return saved entity.
     */
    public BotConfig save(BotConfig data) {
        return persist(data);
    }
     ...
     */
    public void delete(BotConfig data) {
