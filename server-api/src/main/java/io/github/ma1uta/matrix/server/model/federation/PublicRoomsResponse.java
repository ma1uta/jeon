...
public class PublicRoomsResponse {
    ...
    /**
     * A pagination token for the response. The absence of this token means there are no more results to fetch and the client should
     * stop paginating.
     */
    @Schema(
        name = "next_batch",
        description = "A pagination token for the response. The absence of this token means there are no more results to fetch and"
            + " the client should stop paginating."
    )
    ...
    @Schema(
        name = "prev_batch",
        description = "A pagination token that allows fetching previous results. The absence of this token means there are no results"
