...
public class PublicRoomsChunk {
    ...
    /**
     * Required. Whether guest users may join the room and participate in it. If they can, they will be subject to ordinary power level
     * rules like any other user.
     */
    @Schema(
        name = "guest_can_join",
        description = "Whether guest users may join the room and participate in it. If they can, they will be subject to ordinary"
            + " power level rules like any other user.",
        required = true
    )
