...
public interface RoomEventApi {
    ...
    Map<String, Object> eventsForRoomWithTypeAndState(@PathParam("roomId") String roomId, @PathParam("eventType") EventType eventType,
                                                      @PathParam("stateKey") String stateKey);

    @GET
    @Path("/{roomId}/state/{eventType}")
    Map<String, Object> eventsForRoomWithType(@PathParam("roomId") String roomId, @PathParam("eventType") EventType eventType);
    ...
    @PUT
    @Path("/{roomId}/state/{eventType}/{stateKey}")
    SendEventResponse sendEventWithTypeAndState(@PathParam("roomId") String roomId, @PathParam("eventType") EventType eventType,
                                                @PathParam("stateKey") String stateKey, Map<String, Object> event);

    @PUT
    @Path("/{roomId}/state/{eventType}")
    SendEventResponse sendEventWithType(@PathParam("roomId") String roomId, @PathParam("eventType") EventType eventType,
                                        Map<String, Object> event);

    @PUT
    @Path("/{roomId}/send/{eventType}/{txnId}")
    SendEventResponse sendEvent(@PathParam("roomId") String roomId, @PathParam("eventType") EventType eventType,
                                @PathParam("txnId") String txnId, Map<String, Object> event);

    @PUT
    @Path("/{roomId}/redact/{eventType}/{txnId}")
    SendEventResponse redact(@PathParam("roomId") String roomId, @PathParam("eventType") EventType eventType,
