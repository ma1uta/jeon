...
public class DisplayNameCapability {

    /**
     * Required. True if the user is able to change their own display name via profile endpoints.
     * Cases for disabling might include users mapped from external identity/directory services, such as LDAP..
     */
    @Schema(
        description = "True if the user is able to change their own display name via profile endpoints."
            + " Cases for disabling might include users mapped from external identity/directory services, such as LDAP.",
        required = true
    )
