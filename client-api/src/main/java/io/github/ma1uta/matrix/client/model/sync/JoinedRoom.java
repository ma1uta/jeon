...
public class JoinedRoom {
     ...
     */
    @ApiModelProperty("Updates to the state, between the time indicated by the since parameter, and the start of the "
     ...
     */
    @ApiModelProperty("The timeline of messages and state changes in the room.")
    private Timeline timeline;

    /**
     * The ephemeral events in the room that aren't recorded in the timeline or state of the room. e.g. typing.
     */
    @ApiModelProperty("The ephemeral events in the room that aren't recorded in the timeline or state of the room. e.g. typing.")
    private Ephemeral ephemeral;

    /**
     * The private data that this user has attached to this room.
     */
    @ApiModelProperty(name = "account_data", value = "The private data that this user has attached to this room.")
     ...
     */
    @ApiModelProperty(name = "unread_notifications", value = "Counts of unread notifications for this room.")
