...
public class GroupValue {
    ...
    @ApiModelProperty(
        name = "next_batch",
        value = "Token that can be used to get the next batch of results in the group, by passing "
     ...
     */
    @ApiModelProperty(
        value = "Key that can be used to order different groups."
    )
    private Long order;
     ...
     */
    @ApiModelProperty(
        value = "Which results are in this group."
    )
